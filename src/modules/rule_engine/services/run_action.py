...
from modules.rule_engine.domain.repository.common.get_promo_applicable_actions import get_promo_actions
from modules.rule_engine.domain.repository.common.get_discounts_and_benefits import get_discounts_and_benefits
from modules.rule_engine.dto.common.action_results_dto import to_dict

class RunAction:
    @staticmethod
    def execute(applicable_promos: List[IPromo], total_input: float) -> Dict[str, Any]:
        promos_actions =  get_promo_actions(applicable_promos)
